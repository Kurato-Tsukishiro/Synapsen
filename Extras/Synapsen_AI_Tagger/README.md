...
| **テキスト** (Markdown) | **2分38秒** | 2,991文字 | [専門的な講義ノート (薬物動態学: 分布容積)](<../../samples/20250721_025900_投与設計の第一歩 -分布容積の理解-_資料.md> "20250721_025900_投与設計の第一歩 -分布容積の理解-_資料.md") |
...
* **Unsloth QAT版**
    ```json
    {
      "keywords": ["分布容積 (Vd)", "濃度", "溶媒", "組織への移行", "見かけ上の容積"],
      "summary": "分布容積とは、薬が投与された際に、血液だけでなく組織にも広がりやすい性質を示す指標です。血中濃度の低さから、実際の体液量よりも大きな「見かけ上の容積」として計算されます。この概念は、薬剤の投与量を決定する際に重要な役割を果たし、特に脂溶性の高い薬の場合、初回投与量を調整するために活用されます。"
    }
    ```
> **💡 Point:**
