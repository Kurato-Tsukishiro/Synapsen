...
* `tag:`, `memo:`, `date:`, `ikey:`, `fulltext:` (または `text:`) などのプレフィックス検索
...
* 現在の検索結果に基づき、ノート間のリンクを視覚化する「**グラフ表示**」機能
