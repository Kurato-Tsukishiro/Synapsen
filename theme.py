...
# Accent
COLOR_MYOSOTIS = "#89c3eb"
""" 勿忘草色 """
COLOR_HIMAWARI = "#fcc800"
""" 向日葵色 """
COLOR_DOVEGREY = "#9e8b8e"
""" 鳩羽鼠色 """
...
""" Nexus : 鉄色 (基盤) """
COLOR_CANVAS = COLOR_HIMAWARI
""" Canvas : 向日葵色 """

# UI Accent Color
COLOR_UI_BASIC = COLOR_MYOSOTIS
""" 基本的なUIカラー : 勿忘草色 """
COLOR_UI_SECONDARY = COLOR_KIKYO
""" 次点のUIカラー : 桔梗色 """

COLOR_UI_LINK = COLOR_HISUI
""" リンク関連機能のUI, ジャンプ系機能 : 翡翠色 """
COLOR_TEXT_LINK = COLOR_KIKYO
""" リンクテキスト(暗) : 桔梗色 """
COLOR_TEXT_LINK_BRIGHT = COLOR_MYOSOTIS
""" リンクテキスト(明) : 勿忘草色 """

COLOR_UI_EDIT = COLOR_TETSU
""" 編集関連機能のUI : 鉄色 """
COLOR_UI_EXPORT = COLOR_TETSU
""" 出力関連機能のUI : 鉄色 """

COLOR_UI_OTHER = COLOR_DOVEGREY
""" その他のUI要素 : 鳩羽鼠色 """
COLOR_BACKGROUND_PANEL = "#ddd8d8"
"""
パネル背景色 : 薄い灰色 (鳩羽鼠色をベースに明るく調整)
    theme.blend_colors(
        theme.adjust_saturation(theme.COLOR_UI_OTHER, 0.7),
        "#FFFFFF",
        alpha=0.35,
    )
"""
COLOR_BACKGROUND_HOLLOW = "#eae7e7"
"""
窪み背景色 : 非常に薄い灰色 (鳩羽色及びパネル背景色をベースに明るく調整)
    theme.blend_colors("#FFFFFF", theme.COLOR_BACKGROUND_PANEL, 0.4)
"""

COLOR_LABEL_DENGER = COLOR_SUOU
""" 危険ラベル警告 : 蘇芳色 """
COLOR_LABEL_WARNING = COLOR_HIMAWARI
""" 注意ラベル警告 : 向日葵色 """
COLOR_LABEL_INFO = COLOR_MYOSOTIS
""" 情報ラベル警告 : 勿忘草色 """

COLOR_LABEL_SUCCESS = COLOR_HISUI
""" 成功ラベル : 翡翠色 """
