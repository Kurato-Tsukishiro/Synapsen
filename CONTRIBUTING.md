...
2.  **ビルド:** 以下のコマンドをルートディレクトリで実行してください。
    ```bash
    poetry run pyinstaller --noconsole --onefile --name Synapsen --icon=assets/synapsen.ico --splash "assets/synapsen_banner.png" --collect-all customtkinter --collect-all tkinterdnd2 --collect-all pyzbar --collect-all pyvis --hidden-import="PIL._tkinter_finder" --paths="Synapsen_Normalisierer" --paths="Synapsen_Ersteller" --paths="Synapsen_Nexus" --paths="Synapsen_Web" --add-data="Synapsen_Web/templates;Synapsen_Web/templates" --add-data="Synapsen_Web/static;Synapsen_Web/static" --hidden-import="flask" --hidden-import="logging_setup" --hidden-import="theme" --hidden-import="dnd_window" --hidden-import="webclip_window" --hidden-import="image_editor" --hidden-import="pdf_utils" --hidden-import="Synapsen_Watchdog" --hidden-import="pdf_processor" --hidden-import="reportlab_generator" --hidden-import="gui_dialogs" --hidden-import="db_recovery_tool" --hidden-import="config_editor" --hidden-import="PDFMargeHelper" --hidden-import="canvas_window" --hidden-import="createsticky_window" --hidden-import="preview_window" --hidden-import="editor_window" --hidden-import="tag_window" --hidden-import="export_manager" --hidden-import="graph_manager" --hidden-import="list_navigator" --hidden-import="saved_search_manager" --hidden-import="search_parser" --hidden-import="utils" --hidden-import="mixins" --hidden-import="mixins.database_mixin" --hidden-import="mixins.search_mixin" --hidden-import="mixins.ui_mixin" Synapsen_Launcher.py
    ```
